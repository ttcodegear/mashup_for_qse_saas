...
public class MashupJWT {
  private static class MyHandler implements HttpHandler {
    ...
    public String getJWT() throws JWTCreationException, IOException, NoSuchAlgorithmException, InvalidKeySpecException {
      ...
      String[] groups = new String[]{ "Administrators", "Sales", "Marketing" };
      String token = JWT.create()
        ...
        .withClaim("groups", Arrays.asList(groups))
