...
function getjwt() {
  var payload = {
    ...
    iat: Math.floor((new Date()).getTime() / 1000) - 10, // adjust 10-sec...
  ...
  var privatekey = fs.readFileSync('c:\\temp\\privatekey.pem');
  ...
  var signingOptions = {
    ...
    expiresIn: "60m", //Expires 3600 seconds after the issue date/time.
...
const server = http.createServer(function(req,res){
    ...
    res.write(html.replace('{jwttoken}', getjwt()));
    res.end();
});
server.listen(80);
